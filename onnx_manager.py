...
def onnx_run_all_complete(onnx_file, onnx_path, image_file, image_batch, img_size_x, img_size_y, is_grayscale, 
                          minio_bucket, oscar_service, kube_namespace, platform, repetitions, exec_provider, 
  ...
  if warmupTime == None: warmupTime = 10#60
  ...
  inputs= {'mobilenetv2_1.00_160_input': create_ndarray_f32(inputData.shape)}#((1, 160, 160, 3))}
  tmpvar = onnx_tool.model_profile(modelpath,inputs, savenode='node_table.csv')
